...
class WelcomeController extends Controller
{
    public function index()
    {
        ...
        $sets = DB::table('sets')->join('languages as l1', function ($join) {
            ...
            ->select('sets.id','sets.name','sets.user_id', 'sets.set', 'sets.private','sets.visible','sets.subcategory_id', 'sets.language1_id','sets.language2_id','l1.name as language1', 'l2.name as language2')
            ->get();
